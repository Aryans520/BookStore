...
namespace BookStore.Migrations
{
    ...
    [Migration("20250304085737_addsomeseeddata")]
            ...
            modelBuilder.Entity("BookStore.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 4,
                            Description = "کتاب «سرگذشت ندیمه» اثر مارگارت اتوود یک کتاب ضدآرمان‌شهری تخیلی است که برای اولین بار در سال ۱۹۸۵ منتشر شده است",
                            ItemId = 4,
                            Name = "سرگذشت ندیمه"
                        },
                        new
                        {
                            Id = 5,
                            Description = "تس ماجرای دختری زیبا و معصوم است که از شهر کوچکشان به شهری بزرگتر می‌رود تا خانواده واقعیش را ببیند.",
                            ItemId = 5,
                            Name = "تس دوربرویل"
                        });
                });
